...
type EventArgumentTypes<T> = [T] extends [(...args: infer U) => any]
  ? U
  : [T] extends [void]
  ? []
  : [T];

type EventReturnType<T> = T extends (...args: any[]) => any
  ? ReturnType<T>
  : void;

type EventListener<T> = (...args: EventArgumentTypes<T>) => EventReturnType<T>;
